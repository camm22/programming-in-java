 ...
 * until a {@code try} statement is found that catches the thrown value.
 * If no such {@code try} statement is found, then execution of the thread that executed the {@code throw} is terminated
