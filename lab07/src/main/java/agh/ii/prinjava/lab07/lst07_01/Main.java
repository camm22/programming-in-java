 ...
 *
 *     <li><i>Possibly unbounded</i>. While collections have a finite size, streams need not have.
 *     Short-circuiting operations such as {@link Stream#limit(long)} or {@link Stream#findFirst()}
 *     can allow computations on infinite streams to complete in finite time</li>
 *
...
public class Main {
     ...
     *     <li>From a {@code Collection} via the {@link Collection#stream} and {@link Collection#parallelStream} methods</li>
