 ...
 * it defines a collection for storing elements in a sequential order (with duplicates allowed);
...
public class Main {
    ...
    /**
     * Auxiliary method 2: time taken to add elements to the end of a list
     */
    ...
    /**
     * Auxiliary method 3: time taken to add elements to the front of a list
     */
    ...
    /**
     * Auxiliary method 4: time taken to access list elements with "get" method
     */
    ...
    /**
     * ArrayList vs LinkedList performance 1 (adding to the end)
     */
    private static void demo5() {
        ...
        System.out.format("ArrayList/LinkedList DT ratio (adding to the end): %.4f\n", relDT);
    }

    /**
     * ArrayList vs LinkedList performance 2 (adding to the front)
     */
    private static void demo6() {
        ...
        double relDT = (double) dtAL / dtLL;
        System.out.format("ArrayList/LinkedList DT ratio (adding to the front): %.4f\n", relDT);
    }
